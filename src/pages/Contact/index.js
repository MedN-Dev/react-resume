...
export default function Contact() {
  ...
  const handleSubmit = e => {
    ...
    fetch('https://submit-form.com/Y1l9TZEG21CdMoDHpLNz-', {
      method: 'POST',
      headers: {
      ...
      <Container>
        ...
        <WrapperForm className="some-class" onSubmit={handleSubmit}>
          ...
          <TextInput
            ...
            light={false}
            placeholder="Ex: mednabouli@email.com"
            type="email"
          />
          ...
          <ReCAPTCHA
            ref={recaptchaRef}
            sitekey="6Lfv8P8UAAAAAMUJuCCD_dYpH-yM5YszOEoaoRVN"
